    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box
                    sx={{
                        width: { xs: selectedUserId ? "0%" : "100%", md: "35%" },
                            ...
                            filteredSessions.map((chat) => (
                                <React.Fragment key={chat.user_id}>
                                    ...
                                    >
                                        <ListItemAvatar>
                                            <Avatar
                                                src={chat.customer_pic || undefined}
                                                sx={{ bgcolor: "#e8f5e9", width: 44, height: 44 }}
                                            >
                                                <PersonIcon sx={{ color: "#003f29" }} />
                                            </Avatar>
                                        </ListItemAvatar>
                                        <ListItemText
                                            primary={
                    ...
                    {activeChat ? (
                        <>
                            ...
                            >
                                ...
                                <Avatar
                                    src={activeChat.customer_pic || undefined}
                                    sx={{ mr: 2, bgcolor: "#003f29", width: 40, height: 40 }}
                                >
                                ...
                                {groupMessagesByDate(activeChat.messages).map((group) => (
                                    <React.Fragment key={group.date}>
                                        ...
                                        {group.messages.map((m, idx) => {
                                            // From seller's perspective: seller = right, customer = left
                                            ...
                                            return (
                                                ...
                                                >
                                                    <Box
                                                        sx={{
                                                            bgcolor: isSeller ? "#003f29" : "white",
                                                            color: isSeller ? "white" : "#333",
                                                            p: "10px 16px",
                        ...
                        >
                            ...
                            <Typography variant="body2">
                                Pilih pelanggan untuk mulai membalas pesan
                            </Typography>
                        </Stack>
                    )}
                </Box>
